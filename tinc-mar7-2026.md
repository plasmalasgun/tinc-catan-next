...
````
{"version":3,"file":"ChangeColor.d.ts","sourceRoot":"","sources":["../../src/actions/ChangeColor.ts"],"names":[],"mappings":"AAAA,OAAO,EAAE,MAAM,EAAE,cAAc,EAAE,MAAM,aAAa,CAAC;AACrD,OAAO,EAAE,SAAS,EAAE,MAAM,mBAAmB,CAAC;AAE9C,qBAAa,iBAAkB,YAAW,MAAM;IAE3B,QAAQ,EAAE,MAAM;IAAS,OAAO,EAAE;QAAE,YAAY,EAAE,MAAM,CAAC;QAAC,KAAK,EAAE,MAAM,CAAA;KAAE;IAD5F,IAAI,SAAkB;gBACH,QAAQ,EAAE,MAAM,EAAS,OAAO,EAAE;QAAE,YAAY,EAAE,MAAM,CAAC;QAAC,KAAK,EAAE,MAAM,CAAA;KAAE;IAE5F,QAAQ,CAAC,KAAK,EAAE,SAAS;;;;;;;IAWzB,OAAO,CAAC,KAAK,EAAE,SAAS,GAAG,cAAc;CAK1C"}
````
...
export class ChangeColorAction {
    ...
    validate(state) {
        ...
        if (!actor?.isHost && actor?.id !== this.payload.targetSeatId) {
...
````
{"version":3,"file":"ChangeColor.js","sourceRoot":"","sources":["../../src/actions/ChangeColor.ts"],"names":[],"mappings":"AAGA,MAAM,OAAO,iBAAiB;IAET;IAAyB;IAD5C,IAAI,GAAG,cAAc,CAAC;IACtB,YAAmB,QAAgB,EAAS,OAAgD;QAAzE,aAAQ,GAAR,QAAQ,CAAQ;QAAS,YAAO,GAAP,OAAO,CAAyC;IAAG,CAAC;IAEhG,QAAQ,CAAC,KAAgB;QACvB,MAAM,KAAK,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,YAAY,KAAK,IAAI,CAAC,QAAQ,CAAC,CAAC;QACxE,MAAM,YAAY,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,KAAK,KAAK,IAAI,CAAC,OAAO,CAAC,KAAK,CAAC,CAAC;QAE7E,IAAI,YAAY;YAAE,OAAO,EAAE,KAAK,EAAE,KAAK,EAAE,KAAK,EAAE,0BAA0B,EAAE,CAAC;QAC7E,IAAI,CAAC,KAAK,EAAE,MAAM,IAAI,KAAK,EAAE,EAAE,KAAK,IAAI,CAAC,OAAO,CAAC,YAAY,EAAE,CAAC;YAC9D,OAAO,EAAE,KAAK,EAAE,KAAK,EAAE,KAAK,EAAE,qCAAqC,EAAE,CAAC;QACxE,CAAC;QACD,OAAO,EAAE,KAAK,EAAE,IAAI,EAAE,CAAC;IACzB,CAAC;IAED,OAAO,CAAC,KAAgB;QACtB,MAAM,IAAI,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,EAAE,KAAK,IAAI,CAAC,OAAO,CAAC,YAAY,CAAE,CAAC;QAC1E,IAAI,CAAC,KAAK,GAAG,IAAI,CAAC,OAAO,CAAC,KAAK,CAAC;QAChC,OAAO,EAAE,OAAO,EAAE,IAAI,EAAE,QAAQ,EAAE,KAAK,EAAE,CAAC;IAC5C,CAAC;CACF"}
````
...
export declare class ConfigureAgentAction implements Action {
    ...
    type: string;
    constructor(playerId: string, // The Host making the change
    payload: {
        targetPlayerId: string;
        agentType: 'HEURISTIC' | 'LLM' | 'WEBHOOK';
    });
...
````
{"version":3,"file":"ConfigureAgent.d.ts","sourceRoot":"","sources":["../../src/actions/ConfigureAgent.ts"],"names":[],"mappings":"AAAA,OAAO,EAAE,MAAM,EAAE,cAAc,EAAE,MAAM,aAAa,CAAC;AACrD,OAAO,EAAE,SAAS,EAAE,MAAM,mBAAmB,CAAC;AAE9C,qBAAa,oBAAqB,YAAW,MAAM;IAIxC,QAAQ,EAAE,MAAM;IAChB,OAAO,EAAE;QAAE,cAAc,EAAE,MAAM,CAAC;QAAC,SAAS,EAAE,WAAW,GAAG,KAAK,GAAG,SAAS,CAAA;KAAE;IAJxF,IAAI,SAAqB;gBAGhB,QAAQ,EAAE,MAAM,EAAE,6BAA6B;IAC/C,OAAO,EAAE;QAAE,cAAc,EAAE,MAAM,CAAC;QAAC,SAAS,EAAE,WAAW,GAAG,KAAK,GAAG,SAAS,CAAA;KAAE;IAGxF,QAAQ,CAAC,KAAK,EAAE,SAAS;;;;;;;IAgBzB,OAAO,CAAC,KAAK,EAAE,SAAS,GAAG,cAAc;CAY1C"}
````
...
export class ConfigureAgentAction {
    ...
    constructor(playerId, // The Host making the change
    payload) {
        this.playerId = playerId;
        this.payload = payload;
    }
...
````
{"version":3,"file":"ConfigureAgent.js","sourceRoot":"","sources":["../../src/actions/ConfigureAgent.ts"],"names":[],"mappings":"AAGA,MAAM,OAAO,oBAAoB;IAItB;IACA;IAJT,IAAI,GAAG,iBAAiB,CAAC;IAEzB,YACS,QAAgB,EAAE,6BAA6B;IAC/C,OAA+E;QAD/E,aAAQ,GAAR,QAAQ,CAAQ;QAChB,YAAO,GAAP,OAAO,CAAwE;IACrF,CAAC;IAEJ,QAAQ,CAAC,KAAgB;QACvB,MAAM,KAAK,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,YAAY,KAAK,IAAI,CAAC,QAAQ,CAAC,CAAC;QAExE,iDAAiD;QACjD,IAAI,CAAC,KAAK,EAAE,MAAM,EAAE,CAAC;YACnB,OAAO,EAAE,KAAK,EAAE,KAAK,EAAE,KAAK,EAAE,wCAAwC,EAAE,CAAC;QAC3E,CAAC;QAED,MAAM,UAAU,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,EAAE,KAAK,IAAI,CAAC,OAAO,CAAC,cAAc,CAAC,CAAC;QACjF,IAAI,UAAU,EAAE,cAAc,KAAK,OAAO,EAAE,CAAC;YAC3C,OAAO,EAAE,KAAK,EAAE,KAAK,EAAE,KAAK,EAAE,2CAA2C,EAAE,CAAC;QAC9E,CAAC;QAED,OAAO,EAAE,KAAK,EAAE,IAAI,EAAE,CAAC;IACzB,CAAC;IAED,OAAO,CAAC,KAAgB;QACtB,MAAM,IAAI,GAAG,KAAK,CAAC,OAAO,CAAC,IAAI,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,EAAE,KAAK,IAAI,CAAC,OAAO,CAAC,cAAc,CAAE,CAAC;QAE5E,kCAAkC;QAClC,IAAI,CAAC,SAAS,GAAG,IAAI,CAAC,OAAO,CAAC,SAAS,CAAC;QAExC,OAAO;YACL,OAAO,EAAE,IAAI;YACb,OAAO,EAAE,SAAS,IAAI,CAAC,IAAI,qBAAqB,IAAI,CAAC,OAAO,CAAC,SAAS,SAAS;YAC/E,QAAQ,EAAE,KAAK;SAChB,CAAC;IACJ,CAAC;CACF"}
````
...
export class ChangeColorAction implements Action {
  type = 'CHANGE_COLOR';
  constructor(public playerId: string, public payload: { targetSeatId: string, color: string }) {}
...
export class ConfigureAgentAction implements Action {
  ...
  validate(state: GameState) {
    ...
    // Only the Root Admin can change the wiring of a robot
    if (!isRootAdmin) {
...
## File: packages/server/agents/AgentBrain.ts
````typescript
...
## File: packages/server/agents/HeuristicAgent.ts
````typescript
...
const isLocalHost = computed(() => gameStore.state?.players.find((p: any) => p.controllerId === gameStore.playerId)?.isHost);
...
## File: packages/engine/dist/types/index.d.ts.map
````
{"version":3,"file":"index.d.ts","sourceRoot":"","sources":["../../src/types/index.ts"],"names":[],"mappings":"AAAA,OAAO,EAAE
EAAE;QACL,KAAK,EAAE,GAAG,CAAC,MAAM,EAAE,IAAI,CAAC,CAAC;QACzB,aAAa,EAAE,GAAG,CAAC,MAAM,EAAE,YAAY,CAAC,CAAC;QACzC,KAAK,EAAE,GAAG,CAAC,MAAM,EAAE,IAAI,CAAC,CAAC;KAC1B,CAAC;IACF,SAAS,EAAE,MAAM,EAAE,CAAC;IACpB,YAAY,EAAE,MAAM,CAAC;IACrB,gBAAgB,EAAE,MAAM,EAAE,CAAC;IAC3B,UAAU,CAAC,EAAE,CAAC,MAAM,EAAE,MAAM,CAAC,CAAC;IAC9B,WAAW,CAAC,EAAE,GAAG,CAAC;IAClB,UAAU,EAAE,MAAM,CAAC;IACnB,qBAAqB,EAAE,OAAO,CAAC;IAC/B,WAAW,EAAE,MAAM,EAAE,CAAC;CACvB;AAED,MAAM,WAAW,YAAY;IAC3B,EAAE,EAAE,MAAM,CAAC;IACX,MAAM,EAAE,aAAa,EAAE,CAAC;IACxB,QAAQ,CAAC,EAAE;QACT,IAAI,EAAE,YAAY,GAAG,MAAM,CAAC;QAC5B,QAAQ,EAAE,MAAM,CAAC;KAClB,CAAC;CACH;AAED,MAAM,WAAW,QAAQ;IACvB,EAAE,EAAE,MAAM,CAAC;IACX,SAAS,EAAE,MAAM,CAAC;IAClB,IAAI,EAAE,QAAQ,GAAG,MAAM,GAAG,QAAQ,CAAC;IACnC,QAAQ,CAAC,EAAE,MAAM,CAAC;IAClB,OAAO,EAAE,MAAM,CAAC;IAChB,QAAQ,CAAC,EAAE,GAAG,CAAC;CAChB;AAED,MAAM,WAAW,IAAI;IACnB,EAAE,EAAE,MAAM,CAAC;IACX,MAAM,EAAE,aAAa,EAAE,CAAC;IACxB,IAAI,CAAC,EAAE;QACL,QAAQ,EAAE,MAAM,CAAC;KAClB,CAAC;CACH;AAED,MAAM,WAAW,YAAY;IAC3B,KAAK,EAAE,MAAM,CAAC;IAAC,IAAI,EAAE,MAAM,CAAC;IAAC,KAAK,EAAE,MAAM,CAAC;IAAC,KAAK,EAAE,MAAM,CAAC;IAAC,GAAG,EAAE,MAAM,CAAC;CACxE;AAGD,MAAM,WAAW,UAAU;IACzB,QAAQ,EAAE,MAAM,CAAC;IACjB,QAAQ,EAAE,YAAY,CAAC;IACvB,UAAU,EAAE,YAAY,CAAC;IACzB,SAAS,EAAE,GAAG,CAAC,MAAM,EAAE,UAAU,GAAG,UAAU,GAAG,SAAS,CAAC,CAAC;CAC7D"}
````
...
export class StartGameAction implements Action {
  ...
  execute(state: GameState): ActionResponse {
    // 1. MANIFEST AGENTS: Turn all Ghosts into Robots (if any slipped through)
    state.players.forEach((seat: Player) => {
      if (seat.controllerType === null) {
        seat.controllerType = 'AGENT';
        seat.controllerId = `bot_${seat.id}`;
...
export class ToggleControllerAction implements Action {
  ...
  validate(state: GameState) {
    // Check if the person asking to do this is the Root Admin
    const isRootAdmin = (this.playerId === state.hostSessionId);
    
    // Find the seat of the person asking to do this (if they have one)
    const actorSeat = state.players.find(p => p.controllerId === this.playerId);
CAAC,QAAQ,EAAE,OAAO,CAAC,CAAC;YAEhD,KAAK,cAAc;gBACjB,OAAO,IAAI,iBAAiB,CAAC,QAAQ,EAAE,OAAO,CAAC,CAAC;YAElD;gBACE,OAAO,IAAI,CAAC;QAChB,CAAC;IACH,CAAC;CACF"}
````
...
export class GameManager {
    ...
    createGame(creatorId, settings) {
        ...
        const shortId = creatorId.substring(creatorId.length - 5);
        // Pick a random color from the Catan palette
        const colors = ["#e74c3c",
            "#e67e22",
            "#f1c40f",
            "#27ae60",
        ...
        const initialState = {
            ...
            devCardDeck: [],
            setupSequence: [],
            // ONLY ONE SEAT TO START!
            players: [
                this.createNewPlayer(creatorId, shortId, randomColor, true)
            ]
        };
        this.games.set(gameId, initialState);
        return gameId;
    ...
    joinGame(gameId, playerId) {
        ...
        if (!state)
            throw new Error("Game not found");
        // PILLAR 1: RECLAIM SEAT (If they already had one)
        ...
        if (assignedSeat) {
            ...
            // SPECTATOR MODE (Lurk Mode)
            console.log(`👀 SPECTATOR: Player ${playerId} is lurking.`);
            // We do NOTHING. They are not added to the players array.
        }
        return state;
    }
    setPlayerOffline(gameId, playerId) {
        ...
        if (playerLeaving) {
            playerLeaving.isOnline = false; // ⛓️‍💥 Disconnected
            if (playerLeaving.isHost) {
                // Find another ONLINE HUMAN to take the crown
                const nextHost = state.players.find(p => p.isOnline && p.controllerType === 'HUMAN' && p.id !== playerLeaving.id);
                if (nextHost) {
                    playerLeaving.isHost = false;
                    nextHost.isHost = true;
                    ...
                    // FIX: Do NOT strip the crown. Let it stay dormant on this offline seat.
                    console.log(`👑 CROWN DORMANT: Host is offline, but kept the crown for when they return.`);
                }
            }
        }
        return state;
...
export class GameManager {
  ...
  public createGame( creatorId: string, settings: any ): string {
    ...
    const initialState: GameState = {
      id: gameId,
      hostSessionId: creatorId, // <-- ROOT CROWN SET HERE
      phase: 'LOBBY',
      startupIndex: 0,
      startupSubPhase: 'SETTLEMENT',
      currentPlayerId: creatorId,
      ...
      setupSequence:[],
      players:[
          this.createNewPlayer(creatorId, shortId, randomColor, false) // isHost boolean no longer needed!
      ]
    };
  ...
  public joinGame( gameId: string, playerId: string ): GameState {
    ...
    // Reclaim Seat or lurk as Spectator
    let assignedSeat = state.players.find(p => p.controllerId === playerId);
    if (assignedSeat) {
      assignedSeat.isOnline = true;
    }

    // PILLAR 2: ROOT CROWN CLAIMING
    // If there is no active host, or the host's session is empty, the first person to join gets it!
  ...
  public setPlayerOffline( gameId: string, playerId: string ): GameState | null {
    ...
    // Mark their seat offline if they had one
    const playerLeaving = state.players.find(p => p.controllerId === playerId);
    if (playerLeaving) playerLeaving.isOnline = false; 

    // PILLAR 2: ROOT CROWN PASSING
    if (playerId === state.hostSessionId) {
      // The Admin left! Find another online Human to take the Root Crown
      const nextHost = state.players.find(p => p.isOnline && p.controllerType === 'HUMAN');
      
      if (nextHost && nextHost.controllerId) {
        state.hostSessionId = nextHost.controllerId;
        console.log(`👑 CROWN PASSING to ${nextHost.name}`);
      } else {
        state.hostSessionId = ''; // Leave it dormant for the next person to join
